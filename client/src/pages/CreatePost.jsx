...
const CreatePost = () => {
  ...
  //Used while we're making contact with our api, and to set img once created
  ...
  const handleSurpriseMe = () => {
    console.log("Inside handleSurpriseMe ");
      ...
      <div>
        ...
        <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
          ...
          <div className="mt-5 flex gap-5">
              <button type="button" onClick={generatingImage} className="text-white bg-green-700 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center">
